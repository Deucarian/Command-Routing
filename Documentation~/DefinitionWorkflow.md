# Command-Routing: definition workflow
...
3. Use its buttons to exercise execute typed command, execute from component.
4. Inspect the configured hosts and triggers, then open
   [CommandRoutingWorkflow.cs](../Samples~/DefinitionWorkflow/Runtime/CommandRoutingWorkflow.cs). It is the caller
...
- **Execute typed command**: `CommandRoutingWorkflow.Execute()`.
- **Execute from component**: `CommandRoutingWorkflow.ExecuteComponent()`.
